package com.example.dlsh.activity;
...
import com.example.dlsh.R;
import com.example.dlsh.util.CustomVideoView;
 ...
 * @version: 1.0
 */
public class PfspwebActivity extends Activity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pfsp_web_layout);
...
//        //视频播放时开始刷新
//        videoView.start();
        play_controller_image.setImageResource(R.drawable.video_play_blue);
...
//        videoView.setMediaController(controller);
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (screenOritentation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            //竖屏时处理
            setVideoScreenSize(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(this,240));
            screen_flag = true;
        ...
        play_controller_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (videoView.isPlaying()) {
                    ...
                    play_controller_image.setImageResource(R.drawable.iv_pause);
                    videoView.start();
                    //当视频播放时，通知刷新
                    handler.sendEmptyMessage(UPDATA_VIDEO_NUM);
                }
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, PfdtActivity.class);
